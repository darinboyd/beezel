	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProjectPackage.SCENARIO: {
				...
				if (result == null) result = caseTestEntity(scenario);
				if (result == null) result = caseTaggable(scenario);
			...
			case ProjectPackage.FEATURE: {
				...
				if (result == null) result = caseTestEntity(feature);
				if (result == null) result = caseTaggable(feature);
			...
			case ProjectPackage.STORY: {
				Story story = (Story)theEObject;
				T result = caseStory(story);
				if (result == null) result = caseTestEntity(story);
				if (result == null) result = caseTaggable(story);
				if (result == null) result = caseNamedElement(story);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProjectPackage.TAGGABLE: {
				Taggable taggable = (Taggable)theEObject;
				T result = caseTaggable(taggable);
				if (result == null) result = caseNamedElement(taggable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ProjectPackage.TEST_ENTITY: {
				TestEntity testEntity = (TestEntity)theEObject;
				T result = caseTestEntity(testEntity);
				if (result == null) result = caseTaggable(testEntity);
				if (result == null) result = caseNamedElement(testEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
